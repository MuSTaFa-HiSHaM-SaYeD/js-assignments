...
// // js assignments on Lessons: 79-85 // //

////////////////////////////////////////////////
// Assignment 1
// Create Your Object Here

// why if i use "arrow function" as object method, the "this" keyword doesn't work (returns undefined!)
let member ={
    name:"Elzero",
    age:38,
    country:"Egypt",
    fullDetails:function(){return `My Name Is ${member.name}, My Age Is ${this.age}, I Live in ${this.country}`;}
};
...
let myFavGames = {
  ...
  // Code One => How To Get Object Length ? hasownprporty || keys
  let objectLength = Object.keys(myFavGames).length;

  // hasOwnProperty VS hasOwn
//   let o = {l:"j"};
//   console.log(o.hasOwnProperty("n"));
//   console.log(Object.hasOwn(o,"n"));
  ...
  for (let i = 0; i < objectLength; i++) {
    ...
    if (Object.values(myFavGames)[i].hasOwnProperty("bestThree")) 
    {
      ...
      console.log(`Second => ${Object.values(Object.values(myFavGames)[i].bestThree)[1]}`);
